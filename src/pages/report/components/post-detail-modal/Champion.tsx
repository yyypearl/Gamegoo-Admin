...
import { ChampionStatsResponse } from "@/@generated/types";
        ...
        <Champions>
          {list?.map((champion, key) => (
            ...
            >
              <ImageWrapper>
                <img
                  src={`/assets/images/champion/${champion.championId || 0}.png`}
                ...
                />
                <Percentage>{Math.round(champion.winRate || 0)}%</Percentage>
              </ImageWrapper>
              {hoveredIndex === key && (
                <TooltipWrapper ref={tooltipWrapperRef}>
                  ...
                  >
                    ...
                    <ChampionTable>
                      <Head>승률</Head>
                      <Rate>{Math.round(champion.winRate || 0)}%</Rate>
                      <More>
                        {champion.wins || "0"}승{" "}
                        {champion.wins
                          ? (champion.games || 0) - (champion.wins || 0)
                          : "0"}
                        패
                      </More>
                      <Head>KDA</Head>
