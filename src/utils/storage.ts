...
export const getAccessToken = () => {
  if (typeof window !== "undefined") {
    return (
      ...
      sessionStorage.getItem(STORAGE_KEY.accessToken)
    );
  }
  return null;
};
...
export const getRefreshToken = () => {
  if (typeof window !== "undefined") {
    return (
      localStorage.getItem(STORAGE_KEY.refreshToken) ||
      sessionStorage.getItem(STORAGE_KEY.refreshToken)
    );
  }
  return null;
};
...
export const getName = () => {
  if (typeof window !== "undefined") {
    return (
      localStorage.getItem(STORAGE_KEY.name) ||
      sessionStorage.getItem(STORAGE_KEY.name)
    );
  }
  return null;
};
...
export const getUserId = () => {
  if (typeof window !== "undefined") {
    return (
      ...
      sessionStorage.getItem(STORAGE_KEY.userId)
    );
  }
  return null;
};
